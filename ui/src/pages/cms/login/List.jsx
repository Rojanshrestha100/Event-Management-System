...
const List = () => {
    ...
    const handleSubmit = ev => {
        ...
        http.post('/login', form)
            .then(({data}) => {
                console.log(data);
                inStorage('admin_token', data.token)
                ...
                <div className="col-12">
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="adminname" name="adminname" id="adminname" className="form-control" onChange={ev => setInForm(ev, form, setForm)} required />
                        </div>
                        <div className="mb-3">
