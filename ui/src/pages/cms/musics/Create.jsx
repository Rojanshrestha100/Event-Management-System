                ...
                <div className="col-5 mx-auto">
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="number" name="mcontactinfo" id="mcontactinfo" className="form-control" required onChange={ev => setInForm(ev, form, setForm)} />
                        </div>
                        <div className="mb-3">
