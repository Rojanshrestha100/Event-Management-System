...
const Create = () => {
    ...
    const handleSubmit = ev => {
        ...
        http.post('/cms/catreens', formData)
            ...
            <div className="row">
                <div className="col-5 mx-auto">
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            <label htmlFor="name" className="form-label">Catreen Contactinfo</label>
                            <input type="number" name="ccontactinfo" id="ccontactinfo" className="form-control" required onChange={ev => setInForm(ev, form, setForm)} />
                        </div>
                        <div className="mb-3">
